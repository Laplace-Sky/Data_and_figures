...
text(seg_len(10) + 0.6, area_percent(10) + 0.03, sprintf('%.2f%%', 100*area_percent(10)), 'FontSize', fontSize, 'HorizontalAlignment', 'left', 'Color', color_both);
text(seg_len(10) + 3, area_percent_singlestub(10) + 0.05, sprintf('%.2f%%', 100*area_percent_singlestub(10)), 'FontSize', fontSize, 'HorizontalAlignment', 'right', 'Color', color_single);
text(seg_len(10) - 1.5, cover_circle_area_percent(10) - 0.05, sprintf('%.2f%%', 100*cover_circle_area_percent(10)), 'FontSize', fontSize, 'HorizontalAlignment', 'left', 'Color', color_colorcircle);
