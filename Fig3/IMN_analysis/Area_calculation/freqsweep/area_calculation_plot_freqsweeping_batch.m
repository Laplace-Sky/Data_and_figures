...
for f = [0.1:0.1:2.4, 2.45, 2.5:0.1:4.5]   %len_start:len_step:len_stop   
    num_file = num_file + 1;
...
figure
plot(seg_f, area_percent)
hold on
if (IMN_stub_setting == 0) || (IMN_stub_setting == 1)
    plot(seg_f, area_percent_singlestub)
end
plot(seg_f, cover_circle_area_percent)
ylim([0 1])
