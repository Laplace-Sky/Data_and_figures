...
if jump == 0
    ...
    if enable_plot_save
        ...
        color_single = [0 0.65 0];   %green
        color_double = [0.7 0.85 1]; %light blue
...
for len = [97:1:100]   %len_start:len_step:len_stop            % len unit is mm!
    num_file = num_file + 1;
...
figure
plot(seg_len, area_percent)
hold on
if (IMN_stub_setting == 0) || (IMN_stub_setting == 1)
    plot(seg_len, area_percent_singlestub)
end
plot(seg_len, cover_circle_area_percent)
ylim([0 1])
